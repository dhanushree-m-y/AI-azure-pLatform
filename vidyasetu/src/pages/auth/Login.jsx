          ...
          <div className="flex flex-col md:flex-row bg-white rounded-2xl shadow-2xl overflow-hidden max-w-6xl mx-auto">
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8 z-20 text-white">
                      ...
                      <blockquote className="border-l-4 border-yellow-400 pl-4 italic">
                        ...
                        <footer className="text-sm text-gray-300">{item.author}</footer>
                      </blockquote>
                    </div>
                  </div>
                ))}
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              <div className="text-center mb-8">
                <h1 className="text-3xl font-bold text-indigo-900">ಪ್ರವೇಶಿಸಿ</h1>
                <p className="text-xl text-gray-600">Welcome Back to VidyaSetu!</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="pl-10 w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-gray-50"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button 
                    type="button"
                    className="flex justify-center items-center py-2.5 px-4 border rounded-lg shadow-sm bg-white hover:bg-gray-50 transition"
                  >
              ...
              <div className="mt-10 md:hidden">
                <div className="bg-indigo-100 rounded-lg p-4">
                  <p className="italic text-gray-700 mb-2">"{carouselItems[currentSlide].quote}"</p>
                  <p className="text-sm text-gray-600">{carouselItems[currentSlide].author}</p>
                </div>
                ...
                <div className="flex justify-center space-x-2 mt-2">
                  {carouselItems.map((_, index) => (
                    <button
                      key={index}
                      onClick={() => setCurrentSlide(index)}
                      className={`w-2 h-2 rounded-full ${currentSlide === index ? 'bg-indigo-600' : 'bg-gray-300'}`}
                      aria-label={`Go to slide ${index + 1}`}
                    ></button>
                  ))}
                </div>
