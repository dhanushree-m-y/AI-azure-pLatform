    ...
    <div className="min-h-screen p-4" style={{ backgroundColor: colors.darkBg, color: '#F5F5F5' }}>
      ...
      <nav className="mb-6">
        <div className="flex space-x-2 overflow-x-auto pb-2">
          ...
          <button 
            ...
            className="px-4 py-2 rounded"
            style={{ 
              backgroundColor: activeTab === 'success' ? colors.skyBlue : colors.mediumBg,
              color: activeTab === 'success' ? 'white' : '#F5F5F5'
            }}
          >
            Success Stories
          </button>
          <button 
            ...
            className="px-4 py-2 rounded"
            style={{ 
              backgroundColor: activeTab === 'questions-bank' ? colors.cyan : colors.mediumBg,
              color: activeTab === 'questions-bank' ? 'white' : '#F5F5F5'
            }}
          >
            Questions Bank
          </button>
      ...
      <main className="rounded-lg p-4" style={{ backgroundColor: colors.mediumBg }}>
        ...
        {activeTab === 'success' && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-xl font-bold" style={{ color: colors.skyBlue }}>Success Stories Showcase</h2>
              <button className="px-4 py-2 rounded text-white" style={{ backgroundColor: colors.skyBlue }}>
                Share Your Journey
              </button>
            </div>
            ...
            <div className="p-4 rounded-lg" style={{ backgroundColor: colors.lightBg }}>
              <div className="flex items-start">
                <div className="rounded-full p-3 mr-4 text-white" style={{ backgroundColor: colors.skyBlue }}>
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                  </svg>
                </div>
                <div>
                  <h3 className="font-bold">Featured Story: "From 60% to District Topper"</h3>
                  <p className="text-sm text-gray-400">By Anita from Kolar District</p>
                  
                  <div className="mt-3">
                    <p>"I struggled with mathematics until I found VidyaSetu's step-by-step problem solver. The explanations in Kannada helped me understand concepts I had been struggling with for years. With daily practice quizzes and the support of the online community, I improved my scores dramatically. I'm now helping younger students in my village use the platform too."</p>
                  </div>
                  
                  <div className="mt-4 flex space-x-2">
                    <button className="px-3 py-1 rounded text-sm text-white" style={{ backgroundColor: colors.skyBlue }}>
                      Read Full Story
                    </button>
                    <button className="px-3 py-1 rounded text-sm" style={{ backgroundColor: colors.darkBg }}>
        ...
        {activeTab === 'questions-bank' && (
          <div className="space-y-6">
            <h2 className="text-xl font-bold" style={{ color: colors.cyan }}>Community Questions Bank</h2>
            
            <div className="p-4 rounded-lg" style={{ backgroundColor: colors.lightBg }}>
              <h3 className="font-medium mb-3">Contribute a Question:</h3>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                <select 
                  className="px-3 py-2 rounded focus:outline-none focus:ring-2"
                  style={{ backgroundColor: colors.darkBg, focusRing: colors.cyan }}
                >
              ...
              <div className="space-y-3">
                <textarea 
                  ...
                  className="w-full px-4 py-2 rounded focus:outline-none focus:ring-2 h-20"
                  style={{ backgroundColor: colors.darkBg, focusRing: colors.cyan }}
                ></textarea>
                <textarea 
                  placeholder="Answer" 
                ...
                <button className="px-4 py-2 rounded text-white" style={{ backgroundColor: colors.cyan }}>
                  Submit Question
                </button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="space-y-2">
                  {recentQuestions.map((question, index) => (
                    <div 
                      key={index} 
                      className="p-3 rounded hover:opacity-90 transition cursor-pointer" 
                      style={{ backgroundColor: [colors.teal, colors.mint, colors.paleGreen][index % 3] }}
                    >
              ...
              <div>
                <h3 className="font-medium mb-3">Most Helpful Contributors:</h3>
                <div className="space-y-2">
                  {topContributors.map((contributor, index) => (
                    ...
                    >
                      ...
                      <span className="text-sm text-gray-400">({contributor.questions} questions)</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <footer className="mt-6 text-center text-sm text-gray-500">
        <p>VidyaSetu Community Forum - Connecting learners across Karnataka</p>
      </footer>
    </div>
  );
};
