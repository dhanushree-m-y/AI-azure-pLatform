  ...
  return (
    <div className="font-sans bg-indigo-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Welcome Section */}
        <div className="bg-gradient-to-r from-purple-800 to-indigo-800 text-white rounded-xl p-6 shadow-lg mb-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <button className="bg-yellow-400 text-indigo-900 px-6 py-3 rounded-lg font-bold shadow-lg hover:bg-yellow-300 transition btn-shine">
                Continue Learning
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-2xl font-bold text-indigo-900 mb-4">Your Learning Progress</h2>
              ...
              <div className="mt-6 text-indigo-700">
                <p>
            ...
            {/* Recommended Content */}
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-2xl font-bold text-indigo-900 mb-4">Personalized For You</h2>
              
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {studentData.recommendations.map((item, index) => (
                  <div key={index} className="bg-indigo-50 rounded-lg overflow-hidden hover-card-lift">
                    ...
                    <div className="p-4">
                      ...
                      <button className="mt-2 text-indigo-600 font-semibold text-sm hover:text-indigo-800 transition">
                        Start Learning
                      </button>
                    </div>
                  </div>
              ...
              <div className="mt-6 p-4 border border-indigo-200 rounded-lg bg-indigo-50">
                <h3 className="font-bold text-indigo-800 mb-2">Continue Where You Left Off</h3>
                <div className="flex items-center">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-indigo-700">{studentData.continueLearning.title}</p>
                    ...
                    <p className="text-sm text-gray-600 mt-1">{studentData.continueLearning.progress}% complete</p>
                  </div>
                  <button className="bg-indigo-600 text-white px-4 py-2 rounded font-medium hover:bg-indigo-700 transition">
                    Resume
                  </button>
                </div>
              </div>
            ...
            {/* Recent Activity */}
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-2xl font-bold text-indigo-900 mb-4">Recent Activity</h2>
              ...
              <button className="mt-4 text-indigo-600 font-semibold hover:text-indigo-800 transition flex items-center">
                View All Activity
          ...
          <div className="space-y-8">
            {/* Weekly Study Streak */}
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-indigo-900 mb-2">Weekly Study Streak</h2>
              <div className="flex items-center">
            ...
            {/* Next Achievement */}
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-indigo-900 mb-2">Next Achievement</h2>
              <div className="mb-3">
                <p className="text-indigo-700">
              ...
              <p className="text-right text-sm text-gray-600 mt-1">Progress: {studentData.nextAchievement.progress}%</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button className="bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg p-3 text-sm font-medium transition flex flex-col items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-indigo-900 mb-4">Achievement Showcase</h2>
              <div className="space-y-3">
                {studentData.badges.map((badge, index) => (
                  <div key={index} className="flex items-center">
                    <span className="text-2xl mr-2">{badge.icon}</span>
                    <span className="text-indigo-800 font-medium">{badge.name}</span>
                    {badge.level && (
                      <span className="ml-2 text-xs bg-indigo-100 text-indigo-600 px-2 py-1 rounded">
                        {badge.level}
                      </span>
                    )}
                  </div>
              ...
              <div className="mt-4 bg-indigo-100 rounded-lg p-3 text-center">
                <p className="text-indigo-800 font-medium">Points: {studentData.points.toLocaleString()}</p>
            ...
            {/* Weekly Goals */}
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-indigo-900 mb-4">Weekly Goals</h2>
              <div className="space-y-3">
                {studentData.weeklyGoals.map((goal, index) => (
                  <div key={index} className="flex items-center">
                    <div className="flex-1">
                      <p className="text-indigo-800">{goal.goal}</p>
              ...
              <div className="flex space-x-2 mt-4">
                <button className="flex-1 text-indigo-600 border border-indigo-600 px-3 py-2 rounded font-medium hover:bg-indigo-50 transition text-sm">
                  Adjust Goals
                </button>
                <button className="flex-1 bg-indigo-600 text-white px-3 py-2 rounded font-medium hover:bg-indigo-700 transition text-sm">
                  Set New Goals
                </button>
              </div>
            </div>
            ...
            {/* Learning Path */}
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-indigo-900 mb-4">Learning Path</h2>
              <div className="relative pb-4">
                <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-indigo-200"></div>
                <div className="relative flex items-center mb-4">
                  <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center z-10 mr-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <div className="bg-gray-100 rounded px-3 py-2 flex-1">
                    <p className="text-sm text-gray-600">Past Milestones</p>
                  </div>
                </div>
                <div className="relative flex items-center mb-4">
                  <div className="w-8 h-8 rounded-full bg-yellow-400 flex items-center justify-center z-10 mr-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-indigo-900" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <div className="bg-indigo-100 rounded px-3 py-2 flex-1">
                    <p className="text-sm font-medium text-indigo-800">Current Focus</p>
                    <div className="mt-2 space-y-1">
                      {studentData.learningPath.currentFocus.map((focus, index) => (
                        <p key={index} className="text-sm text-indigo-600">• {focus}</p>
                      ))}
                    </div>
                  </div>
                </div>
                <div className="relative flex items-center">
                  ...
                  <div className="bg-gray-100 rounded px-3 py-2 flex-1">
                    <p className="text-sm text-gray-600">Upcoming Goals</p>
                  </div>
                </div>
              </div>
              <div className="mt-2 text-sm text-center text-indigo-700">
                Estimated time to reach next milestone: {studentData.learningPath.estimatedTime}
              </div>
              <button className="w-full mt-4 text-indigo-600 border border-indigo-600 px-4 py-2 rounded font-medium hover:bg-indigo-50 transition">
                View Detailed Path
              </button>
            </div>
          </div>
